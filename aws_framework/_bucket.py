...
class S3Client:
    ...
    @asyncify
    def put_object(
        self, bucket_name: str, key: str, body: bytes, content_type: str, acl: str = "public-read", content_disposition: str = "inline", **kwargs) -> Awaitable[None]:
    ...
    def generate_presigned_url(
        self, key: str, bucket_name: str=cfg.AWS_S3_BUCKET,  expiration: int = 3600, **kwargs
    ) -> Awaitable[str]:
        return self.client.generate_presigned_url(
            "get_object", Params={"Bucket": bucket_name, "Key": key}, ExpiresIn=expiration, **kwargs
        )
