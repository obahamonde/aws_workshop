...
from ._fmt import jsonable_encoder
from ._swagger import extract  # pylint: disable=no-name-in-module
from ._swagger import do_response, html, load, transform
...
class CloudAPI(Application):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.openapi = {
            "openapi": "3.0.0",
            "info": {"title": "Cloud API", "version": "1.0.0"},
            "paths": {},
            "components": {"schemas": {}},
